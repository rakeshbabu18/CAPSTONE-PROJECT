...
function WriteArticle() {
  ...
  const submitArticle = async (articleObj) => {
    ...
    if (!authorId) {
      toast.error("Please login again to publish article");
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      console.error("Error publishing article:", err.response?.data || err.message);
      const errorMessage = err.response?.data?.message || err.response?.data?.error || err.message || "Failed to publish article";
