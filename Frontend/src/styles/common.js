...
export const articleTitle       = "text-base font-semibold text-[#1d1d1f] leading-snug tracking-tight break-words [overflow-wrap:anywhere]"
export const articleExcerpt     = "text-sm text-[#6e6e73] leading-relaxed break-words [overflow-wrap:anywhere]"
...
// --- Individual Article (ArticleById) -------------------
export const articlePageWrapper = "max-w-3xl mx-auto px-6 py-12"
export const articleHeader      = "mb-8"
export const articleCategory    = "text-[0.7rem] font-bold text-[#0066cc] uppercase tracking-widest mb-3 inline-block bg-[#0066cc]/10 px-2.5 py-1 rounded"
export const articleMainTitle   = "text-4xl font-extrabold text-[#1d1d1f] leading-tight tracking-tight mb-6"
export const articleAuthorRow   = "flex items-center justify-between text-sm text-[#86868b] border-t border-b border-[#e8e8ed] py-4 mt-6"
export const authorInfo         = "font-medium text-[#1d1d1f] flex items-center gap-2"
export const articleContent     = "text-[#1d1d1f] leading-[1.8] text-[1.1rem] whitespace-pre-wrap break-words [overflow-wrap:anywhere] mb-12"
export const articleFooter      = "text-xs text-[#a1a1a6] text-right mt-12 py-4 border-t border-[#e8e8ed]"
export const articleActions     = "flex gap-4 mt-8 bg-[#f5f5f7] p-4 rounded-xl border border-[#e8e8ed]"
export const editBtn            = "flex-1 bg-white border border-[#d2d2d7] text-[#1d1d1f] font-medium px-4 py-2.5 rounded-lg hover:bg-blue-50 hover:text-blue-600 hover:border-blue-200 transition-colors text-sm text-center"
export const deleteBtn          = "flex-1 bg-white border border-[#d2d2d7] text-[#1d1d1f] font-medium px-4 py-2.5 rounded-lg hover:bg-red-50 hover:text-red-600 hover:border-red-200 transition-colors text-sm text-center"